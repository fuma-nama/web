...
function DocsNavbar({
  ...
  return (
    <LayoutHeader
      id="nd-subnav"
      className={cn(
        "sticky border-b [grid-area:header] flex flex-col top-(--fd-docs-row-1) z-10 backdrop-blur-sm transition-colors data-[transparent=false]:bg-fd-background/80 layout:[--fd-header-height:--spacing(14)]",
