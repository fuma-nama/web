  ...
  return (
    <Accordions type="single">
      ...
      <Accordion title="How do I get started?">
        You can get started by installing Prisma CLI and initializing a new
        project.
      </Accordion>
      <Accordion title="What databases are supported?">
        Prisma supports PostgreSQL, MySQL, SQLite, SQL Server, MongoDB, and
        CockroachDB.
      </Accordion>
    </Accordions>
  );
...
<Accordions type="single">
  <Accordion title="What is Prisma?">
    Prisma is a next-generation ORM that makes working with databases easy for
...
<Accordions type="multiple">
  <Accordion title="Installation">Run npm install to get started.</Accordion>
  <Accordion title="Configuration">
    Configure your settings in the config file.
  </Accordion>
  <Accordion title="Usage">
...
export function HashLinkedAccordion() {
  return (
    <Accordions type="single">
      <Accordion id="what-is-prisma" title="What is Prisma?">
        Prisma is a next-generation ORM that makes working with databases easy.
      </Accordion>
      <Accordion id="getting-started" title="How do I get started?">
...
<Accordions type="single">
  <Accordion id="prisma-info" title="What is Prisma?">
    Prisma is a next-generation ORM that makes working with databases easy.
  </Accordion>
  <Accordion id="getting-started-guide" title="How do I get started?">
    You can get started by installing Prisma CLI.
  </Accordion>
</Accordions>
