...
export function MyComponent() {
  return <Card>Card content goes here</Card>;
}
```
...
export function CardWithFooter() {
  return (
    <Card>
      ...
      <CardContent>
        Your project is ready to be deployed to production. Click the button
        below to get started.
      </CardContent>
      <CardFooter>
        <Button variant="default-strong">Deploy</Button>
        <Button variant="default-weak" className="ml-2">
          Cancel
        </Button>
      </CardFooter>
    </Card>
...
<div className="my-4">
  <Card>
    ...
    <CardContent>
      Your project is ready to be deployed to production. Click the button below
      to get started.
    </CardContent>
    <CardFooter>
      <Button variant="default-strong">Deploy</Button>
...
<Card>
  ...
  <CardFooter>
    <Button variant="default-strong">Update Now</Button>
...
<Card>
  ...
  <CardContent>
    Learn how to set up Prisma ORM in your Next.js application and start
...
<Card>
  ...
  <CardFooter>
    ...
    <Button type="button" variant="default-weak">
      Cancel
    </Button>
  </CardFooter>
</Card>
