...
<div className="space-y-4 my-4">
  <div className="flex items-center gap-2 mb-2">
    ...
    <label htmlFor="notifications-example" className="text-sm font-medium">
      Notifications
    </label>
  </div>
  <div className="flex items-center gap-2 mb-2">
    <Checkbox id="emails-example" />
    <label htmlFor="emails-example" className="text-sm font-medium">
      Email updates
    </label>
  </div>
  <div className="flex items-center gap-2 mb-2">
    <Checkbox id="sms-example" />
    <label htmlFor="sms-example" className="text-sm font-medium">
      SMS alerts
    </label>
  </div>
</div>
  ...
  return (
    <div className="space-y-4">
      <Field orientation="horizontal" className="items-start">
        ...
        />
        <div className="flex flex-col gap-1">
          <FieldLabel htmlFor="terms-validation">
...
<div className="max-w-md my-4">
  <Field orientation="horizontal" className="items-start">
    ...
    <div className="flex flex-col gap-1">
      <FieldLabel htmlFor="terms-validation-example">
        I accept the terms and conditions
      </FieldLabel>
      <FieldDescription>You must accept to continue.</FieldDescription>
    </div>
...
<form className="space-y-6 max-w-md my-4">
  <div className="space-y-4">
    ...
    <div className="flex items-center gap-2 mb-2">
      ...
      <label htmlFor="marketing-cookies-form" className="text-sm font-medium">
        Allow marketing cookies
      </label>
    </div>
    ...
    <div className="flex items-center gap-2 mb-2">
      ...
      <label htmlFor="third-party-form" className="text-sm font-medium">
        Allow third-party cookies
      </label>
    </div>
  </div>
