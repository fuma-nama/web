---
title: Pulumi
description: Provision and manage Prisma Postgres with Pulumi using the Prisma Terraform provider bridge.
...
const availableRegions = prismaPostgres
  .getRegionsOutput()
