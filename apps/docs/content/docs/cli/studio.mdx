...
metaTitle: prisma studio | Visual Database Browser
metaDescription: "Browse and edit database data with prisma studio. Opens a web UI for PostgreSQL, MySQL, and SQLite. Supports --port and --browser options."
url: /cli/studio
---
