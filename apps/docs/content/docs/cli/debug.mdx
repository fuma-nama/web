...
metaTitle: prisma debug | Debug Info for Troubleshooting
metaDescription: "Print Prisma debug info with prisma debug. Schema paths, engine binaries, env vars, cache dirs. Useful for bug reports and troubleshooting."
url: /cli/debug
---
