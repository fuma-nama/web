...
metaTitle: prisma generate | Generate Prisma Client & Artifacts
metaDescription: "Generate Prisma Client and other artifacts from your schema with prisma generate. Supports --watch, custom output, and multiple generators."
url: /cli/generate
---
