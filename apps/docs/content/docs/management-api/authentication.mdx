...
metaTitle: Management API Authentication | Service Tokens & OAuth 2.0
metaDescription: "Authenticate with Prisma Management API: service tokens for scripts and CI/CD, or OAuth 2.0 with PKCE for user-facing apps. Bearer token in Authorization header."
url: /management-api/authentication
---
