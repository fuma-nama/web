...
url: /studio/integrations/embedding
...
![Diagram showing the execution flow of embedded Prisma Studio: user, Studio UI, React app, backend API, and database.](/img/studio/embedded-flow.png)
