...
- _"Set up Prisma with PostgreSQL in this project"_
- _"Upgrade this project from Prisma 6 to 7"_
- _"Write a query to find all users with their posts"_
- _"Run migrations for production"_
- _"Create a new Prisma Postgres database"_
