...
![Diagram showing cache behavior with TTL and SWR: fresh data for 30 seconds, then stale data served while background revalidation occurs.](/img/accelerate/ttl_and_swr.png)
