...
url: /v6/orm/overview/introduction/should-you-use-prisma
...
Prisma ORM is the only _fully_ type-safe ORM in the TypeScript ecosystem. The generated Prisma Client ensures typed query results even for partial queries and relations. You can learn more about this in the [type-safety comparison with TypeORM](/v6/orm/more/comparisons/prisma-and-typeorm#type-safety).
