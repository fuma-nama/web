...
We’ve removed the `deno` Preview feature from the `prisma-client-js` generator. If you want to use Prisma ORM with Deno, you can now do so with the new [`prisma-client`](https://www.prisma.io/docs/orm/prisma-schema/overview/generators#prisma-client-early-access) generator:
