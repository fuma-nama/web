...
- [\#28291](https://github.com/prisma/prisma/pull/28291) Support multiple Prisma instances with different providers
- [\#28305](https://github.com/prisma/prisma/pull/28305) Add `env` helper function
- [\#28266](https://github.com/prisma/prisma/pull/28266) Add support for `js` or `classic` as engine types in `prisma.config`
- [\#28139](https://github.com/prisma/prisma/pull/28139) Map `Bytes` to `Uint8Array` depending on Typescript version
