...
This depends heavily on _how_ you measure performance.
...
This was a deliberate trade-off, not an oversight. We’re continuing to improve performance in Prisma 7, as seen in [the 7.3.0 release](https://github.com/prisma/prisma/releases/tag/7.3.0), with more incremental improvements on the way.
...
as [first-class databases](https://www.prisma.io/blog/prisma-orm-manifesto#1-defining-first-class-databases).
