...
**Search** now runs on [Mixedbread](https://www.mixedbread.com/) _(an AI search provider)_, which uses AI models to return more accurate results based on your query, not just keyword matching.
