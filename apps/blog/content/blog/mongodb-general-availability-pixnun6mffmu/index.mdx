...
metaImagePath: "/mongodb-general-availability-pixnun6mffmu/imgs/meta-53ef0fef7dc5c54c6cee0c4cce0f47682d09cdc3-1692x882.png"
...
![](/mongodb-general-availability-pixnun6mffmu/imgs/issue.png)
...
![](/mongodb-general-availability-pixnun6mffmu/imgs/autocomplete.gif)
...
- The TypeScript compiler will catch cases where you accidentally access a field that was not returned from the query.
  ![](/mongodb-general-availability-pixnun6mffmu/imgs/compiler-error.png)
- Your auto-completion suggestions are tailored to the given type.
  ![](/mongodb-general-availability-pixnun6mffmu/imgs/autocomplete.png)
...
MongoDB](https://www.prisma.io/docs/getting-started/prisma-orm/quickstart/mongodb?utm_source=website&utm_medium=blogpost&utm_campaign=mongodblaunch)
...
<br />
[Add Prisma to existing MongoDB
project](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/mongodb?utm_source=website&utm_medium=blogpost&utm_campaign=mongodblaunch)
...
![](/mongodb-general-availability-pixnun6mffmu/imgs/launchweek.png)
