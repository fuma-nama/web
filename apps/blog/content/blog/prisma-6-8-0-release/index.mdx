...
metaImagePath: "/prisma-6-8-0-release/imgs/meta-ad55ab4fb3e73f6d3379697f1082600814e40c89-1266x711.png"
heroImagePath: "/prisma-6-8-0-release/imgs/hero-b3ae90f7c076b2606757271bab4e04cffe8bb03d-844x474.svg"
...
**_That should never be the case._**
...
Just type: _“Create a database for me and store the connection string in an_ `.env` _file” …and it’s done._ No terminal hopping, no context switching.
...
You’re deep in code, writing a query, building a new model, testing out migrations. But then you pause..._What’s the syntax for that one-to-many relationship again?_

**Context switching kills momentum.**

With the **Prisma for GitHub Copilot** extension, you don’t have to leave your editor to find out. Just ask: “_@prisma-for-github-copilot How can I cache my prisma queries?”_

The answer appears right inside **GitHub Copilot Chat**.

![A dark-themed GitHub Copilot Chat pane titled “Ask Copilot,” showing usage tips (“or type # to attach context,” “@ to chat with extensions,” “Type / to use commands”). In the bottom input box, the user types “@prisma How can I cache my prisma queries?” The Copilot Chat pane then displays a detailed reply explaining strategies for caching Prisma query results directly in code.](/prisma-6-8-0-release/imgs/a7feebd273dadac60fbfc8dfd95fddd83fd28411-800x785.gif)
...
And it wasn’t just our decision, _it was yours_. You voted and now Singapore is live.
...
We’re working to build a more powerful developer experience with Prisma 6.8.0 and beyond. From local-first database development and real-time documentation lookups to edge-ready Deno deployments, it's all designed to keep you coding, _not configuring_.
