...
metaImagePath: "/optimizing-postgres-for-global-apps/imgs/meta-2d60d46aec9dc44a8e90072330ce14346817df5b-1266x711.png"
heroImagePath: "/optimizing-postgres-for-global-apps/imgs/hero-8633a2e3d0da7dccae76ab2597e841ac444cbe7a-844x474.svg"
tags:
  - "education"
---
...
![](/optimizing-postgres-for-global-apps/imgs/df130688a802da5bd87e58fd82ef867d28fd8a82-1269x1660.png)
...
![](/optimizing-postgres-for-global-apps/imgs/e003a199c4bfcfff090449148d3185d331d5a113-1269x1660.png)

14 messages just to execute a query! For the wEll aCTuaLLy readers, not all of these messages are blocking. Multiple arrows in the same direction are sent without waiting for any response, so technically we have 4 I/O blocking sequences. The prepare phase is expected to be reused with different parameter values _on the same connection_, taking this to a harmless pair of 2 I/O sequences: one to the server and one back to the client forming a single round-trip. That's not so bad! Fortunately for this blog post, there's more to unpack…
...
![](/optimizing-postgres-for-global-apps/imgs/a1acd9147d4e1ffc6b0284fc578538ab7fbc541e-1269x1660.png)
