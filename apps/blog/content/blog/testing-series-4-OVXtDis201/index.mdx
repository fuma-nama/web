...
![Login page](/testing-series-4-OVXtDis201/imgs/login.png)
...
![Playwright config options output](/testing-series-4-OVXtDis201/imgs/playwright-options.png)
...
![Empty test suite results](/testing-series-4-OVXtDis201/imgs/empty-suite.png)

_The test report should be empty. There are no tests!_
...
```ts
test("should allow you to submit a post", async ({ page }) => {
  // Login
...
![Login page intellisense](/testing-series-4-OVXtDis201/imgs/intellisense.png)
...
![Successful test](/testing-series-4-OVXtDis201/imgs/single-success.png)

_You will see three rows because your test is run in three different browsers by default._
...
![Invalid login attempt](/testing-series-4-OVXtDis201/imgs/invalid-login.png)

_Notice the popup on the bottom right._
...
![Two successful tests](/testing-series-4-OVXtDis201/imgs/two-success.png)
...
![Three sets of successful tests](/testing-series-4-OVXtDis201/imgs/three-success.png)
...
![Four sets of successful tests](/testing-series-4-OVXtDis201/imgs/four-success.png)
...
![Set of five successful tests](/testing-series-4-OVXtDis201/imgs/five-success.png)
