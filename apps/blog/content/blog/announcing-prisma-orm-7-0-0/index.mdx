...
<Quotes
  ...
  companyName="Deno"
>
  “We remember hearing about Prisma’s move away from Rust and thinking about how
  not dealing with the native addon API would make supporting Prisma in Deno so
  much simpler. We were all really excited to see it!"
</Quotes>
...
>
  “I upgraded a few weeks ago and it was great to see how well everything went
  and how easy it was to switch to the new Rust-Free Client."
</Quotes>
...
>
  “Whenever I work with Prisma, I get to the getting started guide, install
  things and then realize I needed to go get a database. I’d always get lost in
  that process so being able to create a database this easily is amazing!”
</Quotes>
