...
- Using a database driver written in _Rust_.
- Using a [driver adapter](https://www.prisma.io/docs/orm/overview/databases/database-drivers#driver-adapters) and driver both written in _TypeScript_.
...
![Prisma ORM communicating with a database](/from-rust-to-typescript-a-new-chapter-for-prisma-orm/imgs/598f7a3ad7506e4515a5b40eead655dcf35c0551-1280x600.png)
...
![Prisma ORM communicating with a database via a driver adapter.](/from-rust-to-typescript-a-new-chapter-for-prisma-orm/imgs/c63df7c781f89520601e5a727a48e01b07475569-1280x889.png)
...
![Prisma ORM communicating with a database in the query compiler project](/from-rust-to-typescript-a-new-chapter-for-prisma-orm/imgs/1a90825c7f7897d07fa9422a4c9a2415befb0a80-1480x695.png)
...
_Want to be among the first to try our new Early Access client? [Follow us on X](https://pris.ly/x) and [join our Discord](https://pris.ly/discord) to stay updated._
