---
title: "Tutorial: Building a Realtime GraphQL Server with Subscriptions"
slug: "tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427"
date: "2018-04-26"
authors:
  - "Nikolas Burk"
metaTitle: "Build a Realtime GraphQL Server with Subscriptions | Prisma"
metaImagePath: "/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/hero-781be5bd42b889008892c3564dc6bc915c33581f-2000x1050.png"
heroImagePath: "/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/hero-781be5bd42b889008892c3564dc6bc915c33581f-2000x1050.png"
heroImageAlt: "Tutorial: Building a Realtime GraphQL Server with Subscriptions"
---

GraphQL subscriptions allow clients to receive realtime updates from a GraphQL API upon specific events.

Added to the [official GraphQL spec](https://spec.graphql.org/June2018/#sec-Subscription) only
...
const server = new GraphQLServer({
  ...
  context: (req) => ({
    ...
    db: new Prisma({
      ...
      endpoint:
        "https://eu1.prisma.sh/public-scytheeater-265/subscriptions-example/dev",
      secret: "mysecret123",
      debug: true,
    }),
  }),
...
![](/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/1*GoxKn35GhQpmHZ6bnKbDZA.png)
...
![](/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/1*9fDpnhWdRrgN-vxB3HmLeQ.png)
...
![](/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/1*c6bexq2J0bTeT5UioGjl_A.png)
...
![](/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/1*TisP6j41cu4itqI__dDE-w.png)
...
![](/tutorial-building-a-realtime-graphql-server-with-subscriptions-2758cfc6d427/imgs/1*1vMUL8w54yIAxOPVSR0UjQ.png)
