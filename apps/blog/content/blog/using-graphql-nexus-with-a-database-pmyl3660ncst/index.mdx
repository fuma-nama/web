...
metaImagePath: "/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/hero-d5d2d2a170d84629937a237d833679a49653a117-1200x630.png"
heroImagePath: "/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/hero-d5d2d2a170d84629937a237d833679a49653a117-1200x630.png"
...
![Writing GraphQL server code with nexus and nexus-prisma](/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/dbEMHd5.png)
...
mutation {
  createPost(
    data: {
      title: "Hello World"
      author: { create: { email: "bob@prisma.io" } }
    }
  ) {
    id
    published
...
![Expose full CRUD GraphQL API via nexus-prisma](/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/RLsS1lm.png)
...
![Hide a field from the User model](/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/Zwby9Hs.png)
...
![Customize the GraphQL API via nexus-prisma](/using-graphql-nexus-with-a-database-pmyl3660ncst/imgs/64ipcsj.png)
