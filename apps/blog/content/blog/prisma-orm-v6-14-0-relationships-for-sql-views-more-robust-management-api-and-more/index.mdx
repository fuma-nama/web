...
In case you missed it: Our [last release](https://pris.ly/release/6.14.0) was _huge_ and packed with new features! Here's the TLDR of what we put out last time:
...
- **Prisma Postgres**
  - **Extension support for Prisma Postgres** – Prisma Postgres now supports `pgvector`, `pg_search`, `pg_stat_statements`, `citext`, `pg_trgm`, `fuzzystrmatch`, and `unaccent`. If you don't see the extension you need, you can [request it here](https://pris.ly/i-want-extensions). Extensions only work on _new_ instances, if you want to use any of them on your existing instance, [reach out to us](mailto:support@prisma.io).
