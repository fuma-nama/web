...
metaImagePath: "/introducing-instant-app-deployments-in-partnership-with-vercel/imgs/meta-361d392f23fa013b8ba4f778b7727c0807fc1aca-1266x711.png"
heroImagePath: "/introducing-instant-app-deployments-in-partnership-with-vercel/imgs/hero-38b924b5e2a902a17211a9d7a9493153361dbc43-844x474.svg"
...
4. **Users receive a production URL** where their application is live. All in just a single action. Users can also _claim_ the deployed application in their own Vercel account.
...
const api = (path: string, body: any, method = "POST") =>
  fetch(`${API}${path}${path.includes("?") ? "&" : "?"}teamId=${TEAM_ID}`, {
    method,
    headers: {
