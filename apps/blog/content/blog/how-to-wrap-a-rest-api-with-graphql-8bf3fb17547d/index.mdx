...
metaImagePath: "/how-to-wrap-a-rest-api-with-graphql-8bf3fb17547d/imgs/hero-bf82758030919645523931bf645440e96386e06f-720x385.png"
heroImagePath: "/how-to-wrap-a-rest-api-with-graphql-8bf3fb17547d/imgs/hero-bf82758030919645523931bf645440e96386e06f-720x385.png"
...
![](/how-to-wrap-a-rest-api-with-graphql-8bf3fb17547d/imgs/1*m5LM8FgXa0VEMz-KwMyd3Q.png)
...
![](/how-to-wrap-a-rest-api-with-graphql-8bf3fb17547d/imgs/1*UF5m7oNBcs1LKPboj7GQ8A.png)
...
const resolvers = {
  ...
  Post: {
    author: (parent) => {
      const { id } = parent;
      return fetch(`${baseURL}/blog/posts/${id}/user`).then((res) =>
        res.json(),
      );
    },
  },
...
![](/how-to-wrap-a-rest-api-with-graphql-8bf3fb17547d/imgs/1*0mbKo-p6qfrBKgAaJb0gOQ.png)
