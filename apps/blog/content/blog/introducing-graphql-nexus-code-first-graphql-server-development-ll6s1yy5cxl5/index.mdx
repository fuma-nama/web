...
![Type-safe, compatible with GraphQL ecosystem & data-agnostic](/introducing-graphql-nexus-code-first-graphql-server-development-ll6s1yy5cxl5/imgs/KMUm6rd.png)
...
![SDL converter](/introducing-graphql-nexus-code-first-graphql-server-development-ll6s1yy5cxl5/imgs/AbkFWNO.png)
