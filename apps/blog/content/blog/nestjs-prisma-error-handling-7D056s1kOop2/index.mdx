...
In this tutorial, you will be using the REST API built in the [first chapter](/nestjs-prisma-rest-api-7D056s1BmOL0). You do not need to complete the [second chapter](/nestjs-prisma-validation-7D056s1kOla1) to follow this tutorial.
...
The starting point for this tutorial is the ending of [part one](/nestjs-prisma-rest-api-7D056s1BmOL0) of this series. It contains a rudimentary REST API built with NestJS.
...
{/* ![Requesting an article that does not exist returns HTTP 200](/nestjs-error-handling/article-not-exist-200.png) */}
