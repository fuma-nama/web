...
metaImagePath: "/prisma-migrate-dx-primitives/imgs/meta-b291800991f4a03d10765a87a3fbc6d0e036564c-1270x639.png"
...
![`prisma migrate diff` in action](/prisma-migrate-dx-primitives/imgs/diff-history-db.png)
...
![`migrate diff` and `db execute` example with a file](/prisma-migrate-dx-primitives/imgs/diff-execute-db.png)
