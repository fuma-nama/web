...
metaImagePath: "/whats-new-in-prisma-q1-2021-spjyqp0e2rk1/imgs/hero-d9d93ef80b0722fa2c50737272fd764619c66972-1692x852.png"
...
```js
[
  { location: "Los Angeles", min: { rate: 10.0 } },
  { location: "London", min: { rate: 20.0 } },
  { location: "Tokyo", min: { rate: 30.0 } },
];
```
...
```js
[
  { location: "London", rate: 20.0, min: { rate: 20.0 } },
  { location: "Tokyo", rate: 30.0, min: { rate: 30.0 } },
];
```
...
<Meetup
  ...
  talks={[
    ...
    {
      title:
        "Evolution of Application Data Platforms – From Facebook to Twitter",
      author: "Pete Hunt",
    },
  ]}
  imagePath="/blog/posts/meetup-prisma.png"
