...
- [Authentication and securing the GraphQL API using Auth0](#authentication-and-securing-the-graphql-api-using-auth0)
  ...
  - [Create links – auth protected page](#create-links--auth-protected-page)
...
> Refer to [Part 1 – Add Prisma to your Project](/fullstack-nextjs-graphql-prisma-oklidw1rhw#add-prisma-to-your-project) for more details on the format of the connection string.
...
To secure the app, you will use [Auth0](https://auth0.com) – an authentication and authorization drop-in solution.
...
![Auth0 Dashboard](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-home.png)
...
![Creating a new Auth0 application](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-create-application.png)
...
![Auth0 application settings](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-app-settings.png)
...
![Auth0 app configuring URLs](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-app-settings-url.png)
...
![Auth0 Login/ Signup page](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/app-login-signup.png)
...
![Auth0 Actions choose flow](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-actions-login.png)

Next, to create a new Action, click the **+** icon and choose **Build custom**.

![Create a custom Auth0 Action](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-actions-ui.png)

Pick a name for your custom Action, for example, "Create DB User" and complete the process by selecting **Create**.

![Create Action](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-actions-create-new.png)

After completing the previous step, you will be able to manage your newly created Action.

![Auth0 Action management](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-actions-define-action.png)
...
![Include package in Auth0 Action](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-action-add-module.png)
...
![Auth0 add environment variables](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-action-add-hook-secret.png)
...
exports.onExecutePostLogin = async (event, api) => {
  ...
  // 4.
  const request = await fetch("http://localhost:3000/api/auth/hook", {
    // "localhost:3000" will be replaced before deploying this Action
    method: "post",
...
1. Retrieves user's email from the login event – provided by Auth0
1. Sends a `POST` request to an API route – `http://localhost:3000/api/auth/hook`
...
![Ngrok exposing localhost:3000](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/ngrok.png)
...
![Customize the Loginflow](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/auth0-action-customize-login-flow.png)
...
![Prisma Studio – Created User](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/prisma-studio-created-user.png)
...
![Prisma Studio – update user role](/fullstack-nextjs-graphql-prisma-3-clxbrcqppv/imgs/prisma-studio-role-update.png)
