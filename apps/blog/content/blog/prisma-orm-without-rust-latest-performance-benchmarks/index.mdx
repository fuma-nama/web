...
Over the past few [releases](https://github.com/prisma/prisma/releases/), we’ve gradually rolled out [Preview](https://www.prisma.io/docs/orm/more/releases#preview) support for Prisma ORM for all major SQL databases supported by Prisma ORM. It’s now available for: PostgreSQL, CockroachDB, Neon, MySQL, MariaDB, PlanetScale, SQLite, D1 and MS SQL Server databases.
...
3. Install a [driver adapter](https://www.prisma.io/docs/orm/overview/databases/database-drivers#driver-adapters) for your database (e.g. `@prisma/adapter-pg` if you’re using PostgreSQL):
