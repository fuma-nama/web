...
metaImagePath: "/wnip-q1-dsk0golh8v/imgs/meta-e22bcc2581574927cdd406404700fda3e9efb665-1692x852.png"
...
- A `having` filter on an aggregated field _will_ return `undefined` fields. This is because aggregation on undefined fields yields `null`, not `undefined`, thus matching the filter.
...
await prisma.address.findMany({
  where: {
    OR: [{ street: { isSet: false } }, { street: null }],
  },
});
```
