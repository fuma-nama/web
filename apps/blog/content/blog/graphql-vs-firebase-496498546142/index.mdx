...
metaImagePath: "/graphql-vs-firebase-496498546142/imgs/hero-c257f8c747d9610f835954d2fe2601bda2b0bff3-720x385.png"
heroImagePath: "/graphql-vs-firebase-496498546142/imgs/hero-c257f8c747d9610f835954d2fe2601bda2b0bff3-720x385.png"
...
mutation {
  createTweet(
    data: {
      text: "GraphQL is awesome!"
      author: { connect: { id: "abcdefghijklmnopq" } }
    }
  ) {
    id
  }
...
mutation {
  createUser(
    data: {
      username: "lee"
      tweets: [{ create: { text: "This is my first Tweet 😎" } }]
    }
  ) {
    id
    tweets {
