...
Prisma ORM now provides Early Access support for React Native and Expo, fulfilling a popular community request. The integration introduces _reactive queries_, using React hooks to auto-update the UI when the underlying data changes.
