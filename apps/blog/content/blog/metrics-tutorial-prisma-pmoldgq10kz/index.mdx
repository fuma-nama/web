...
metaImagePath: "/metrics-tutorial-prisma-pmoldgq10kz/imgs/meta-f9d1d442f04a6301edbf164092172e4a4ea43981-1269x714.png"
heroImagePath: "/metrics-tutorial-prisma-pmoldgq10kz/imgs/hero-a497e6ffb8b0aa20963e60b3940d638c938adbf7-835x470.png"
...
> **Note**: If you close the terminal window running the Docker container, it will also stop the container. You can avoid this if you add a `-d` option to the end of the command, like this: `docker-compose up -d`. 5. Apply database migrations from the `prisma/migrations` directory:

```shell npx prisma migrate dev

```

> **Note**: This command will also generate Prisma Client and seed the database. 6. Start the server:
...
![Metrics in Prometheus format](/metrics-tutorial-prisma-pmoldgq10kz/imgs/metrics-prometheus-format.png)
...
![Prometheus UI](/metrics-tutorial-prisma-pmoldgq10kz/imgs/prometheus-ui.png)
...
![Query execution result in Prometheus UI expression browser](/metrics-tutorial-prisma-pmoldgq10kz/imgs/prom-ui-execute-query-table.png)
...
![Query execution result in graph format](/metrics-tutorial-prisma-pmoldgq10kz/imgs/prom-ui-graph.png)
...
![Application architecture with Prometheus and Grafana](/metrics-tutorial-prisma-pmoldgq10kz/imgs/metrics-architecture.png)
...
![Grafana landing page](/metrics-tutorial-prisma-pmoldgq10kz/imgs/grafana-landing.png)
...
![Grafana data source configuration](/metrics-tutorial-prisma-pmoldgq10kz/imgs/grafana-datasource-setup.gif)
...
![Creating a dashboard in Grafana](/metrics-tutorial-prisma-pmoldgq10kz/imgs/dashboard-grafana.gif)
...
![Importing a dashboard in Grafana](/metrics-tutorial-prisma-pmoldgq10kz/imgs/import-dashboard-grafana.gif)
